 ...
 * @version 11/3/2018
 * 
 * InsertionSort is a concrete class which implements SortMethod.java
 */

/**
 * InsertionSort uses the traditional insertion sort algorithm to sort
 * an array of Items.
 */
public class InsertionSort implements SortMethod {
    ...
    public void sort(Item vec[]) throws NullPointerException {
        ...
        for (currentPos = 1; currentPos < n; currentPos++) {
            insPos = findInsPosition(vec, currentPos - 1, vec[currentPos].key);
